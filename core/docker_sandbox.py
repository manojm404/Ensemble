...
class SecureDockerContainer:
    ...
    async def run(
        ...
        try:
            ...
            result = ContainerResult(
                ...
                error=stderr_data.strip() if self.status == ContainerStatus.FAILED else "",
                metadata={
                    "image": self.image,
    ...
    async def _cleanup_container(self) -> None:
        ...
        if self.container_name:
            try:
                ...
                logger.warning("Failed to remove container %s: %s", self.container_name, exc)
    ...
    def get_security_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "network_mode": self.network_mode,
            "seccomp_profile": "enabled" if self.seccomp_profile or True else "disabled",
