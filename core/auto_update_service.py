...
from core.marketplace_sync import MarketplaceSync, MarketplaceSource
...
class AutoUpdateService:
        ...
        try:
            for pack_id, local_version in installed_packs.items():
                ...
                if update_info.get('has_update'):
                    print(f"📢 [AutoUpdate] Update available: {pack_id} {local_version} → {update_info['remote_version']}")
    ...
    async def _apply_update(
        ...
        try:
            ...
            print(f"✅ [AutoUpdate] Successfully updated {pack_id} to {update_info['remote_version']}")
        ...
        try:
            await ws_manager.broadcast(
                ...
                data={
                    ...
                    'pack_name': update_info.get('remote_pack', {}).get('name', pack_id),
