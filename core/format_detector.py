...
IGNORED_FILENAME_PATTERNS = [
    r"^test_", r"_test\.py$", r"^conftest\.py$", r"^setup\.py$",
    r"^requirements.*\.txt$", r"^Makefile$", r"^Dockerfile$",
    r"^\.env", r"^pyproject\.toml$", r"^setup\.cfg$",
]
...
AGENT_JSON_KEYS = {
    "name", "description", "role", "prompt", "system_prompt",
    "instructions", "tools", "model", "agent_type", "category",
}
