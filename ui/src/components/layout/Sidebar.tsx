    ...
    <aside className="w-64 shrink-0 h-full border-r border-border/20 bg-background/30 backdrop-blur-md flex flex-col z-20">
      <ScrollArea className="flex-1">
        <div className="px-4 py-6 space-y-2">
          {/* Action Button */}
          <Button size="sm" className="w-full justify-start gap-2.5 text-xs font-bold mb-4 h-10 bg-primary/95 text-primary-foreground hover:bg-primary shadow-lg shadow-primary/10 rounded-xl" onClick={() => navigate("/")}>
          ...
          <SidebarItem icon={Activity} label="Activity" onClick={() => navigate("/activity")} />
      ...
      <div className="p-3 bg-white/5 border-t border-white/5 pb-8">
          ...
          <button className="flex items-center gap-3 w-full px-4 py-2.5 rounded-xl text-[11px] font-bold text-muted-foreground/50 hover:text-foreground hover:bg-white/5 transition-all group mt-1">
            <div className="h-5 w-5 rounded-lg bg-white/5 border border-white/5 flex items-center justify-center group-hover:bg-primary/20 group-hover:border-primary/20 transition-all">
