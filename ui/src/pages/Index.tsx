      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <Button size="sm" variant="default" onClick={() => handleAppOpen("workflows")}>
              <Plus className="h-4 w-4 mr-2" />
              New Workflow
            </Button>
            <Button size="sm" variant="outline" onClick={() => handleAppOpen("chat")}>
              <MessageSquare className="h-4 w-4 mr-2" />
              Chat
            </Button>
            <Button size="sm" variant="outline" onClick={() => handleAppOpen("agents")}>
